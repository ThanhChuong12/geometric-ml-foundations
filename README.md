...
| :--- | :---: | :--- | :--- |
| **Lê Hà Thanh Chương** | `23120195` | **Project Lead & ML Engineer** | Served as the project manager and report coordinator, managing overall timelines, establishing the LaTeX environment, standardizing document formatting, and compiling the final report. Authored Chapter 1 (Introduction, Background, and Motivation) and Chapter 5 (Detailed Experiments on NequIP). Built the complete web demo system and inference backend for Part 3 (NequIP & QM9) to visualize molecular structure energy predictions. |
| **Trà Văn Sỹ** | `23120197` | **Frontend & ML Engineer** | Authored Sections 3.1 and 3.2 of Chapter 3 (basic methods for symmetry-preserving model construction) and Chapter 6 (Overall Evaluation and Conclusion). Set up the project's initial web frontend architecture, implemented the Part 1 demo (rotated MNIST and equivariant CNNs), and authored the corresponding demonstration Jupyter Notebook. |
| **Huỳnh Đức Thịnh** | `23120199` | **ML Engineer & Researcher** | Authored the remaining sections of Chapter 3, providing a detailed analysis of the PointNet architecture and invariant/equivariant feature extraction mechanisms on point clouds. Developed the core machine learning implementation and training pipeline for the Part 2 demo (PointNet on ModelNet40). |
| **Bùi Trung Hiếu** | `23120257` | **ML Researcher & Slide Designer** | Authored Chapter 2 on foundational mathematical concepts (group theory, group actions, orbits, and mathematical representations of invariance and equivariance) and designed the illustrative TikZ diagrams. Assisted with source code analysis and drafted the Jupyter Notebook for Part 3 (NequIP). Co-designed the final presentation slides and visualized complex geometric concepts. |
| **Lê Công Phúc** | `23120330` | **ML Engineer & Researcher** | Authored Chapter 4 on advanced theoretical topics (sample complexity, weight space learning, parameter symmetry, and symmetry testing). Wrote the experimental analysis, visualization, and evaluation Jupyter Notebook for the Part 2 demo (PointNet on ModelNet40). Co-designed the project presentation slides, selecting key highlights and refining the presentation layout. |
