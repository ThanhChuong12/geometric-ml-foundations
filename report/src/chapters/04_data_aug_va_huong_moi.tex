...
\subsection{Tổng quan hàm mất mát và gộp mô hình}
...
\vspace{-2.0em}
\noindent\textit{Ghi chú: Khi hai nghiệm chưa được căn chỉnh, đoạn nối giữa chúng có thể đi qua vùng mất mát cao. Sau khi căn chỉnh orbit, nội suy tuyến tính giữa hai nghiệm có thể duy trì mất mát thấp.}
